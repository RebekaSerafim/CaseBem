...
from repo import fornecedor_produto_repo, usuario_repo, produto_repo, profissional_repo
...
class TestFornecedorProdutoRepo:
    ...
    def test_inserir_fornecedor_produto(self, test_db, fornecedor_produto_exemplo, profissional_exemplo, produto_exemplo):
        # Arrange
    ...
    def test_atualizar_fornecedor_produto(self, test_db, profissional_exemplo, produto_exemplo):
        # Arrange
        usuario_repo.criar_tabela_usuarios()
        produto_repo.criar_tabela_produtos()
        fornecedor_produto_repo.criar_tabela_fornecedor_produto()
    ...
    def test_excluir_fornecedor_produto(self, test_db, fornecedor_produto_exemplo, profissional_exemplo, produto_exemplo):
        # Arrange
        usuario_repo.criar_tabela_usuarios()
        produto_repo.criar_tabela_produtos()
        fornecedor_produto_repo.criar_tabela_fornecedor_produto()
    ...
    def test_obter_fornecedor_produto_por_id(self, test_db, fornecedor_produto_exemplo, profissional_exemplo, produto_exemplo):
        # Arrange
        usuario_repo.criar_tabela_usuarios()
        produto_repo.criar_tabela_produtos()
        fornecedor_produto_repo.criar_tabela_fornecedor_produto()
        ...
        assert fp.id_profissional == 1
        assert fp.id_produto == 1
        assert fp.observacoes == "Observações teste"
        assert fp.preco == 50.0

    def test_obter_fornecedores_produto_por_pagina(self, test_db, profissional_exemplo, lista_produtos_exemplo):
        # Arrange
        usuario_repo.criar_tabela_usuarios()
        produto_repo.criar_tabela_produtos()
        fornecedor_produto_repo.criar_tabela_fornecedor_produto()
