...
def validar_data_nascimento(
    data_str: Optional[str], idade_minima: int = 16
) -> Optional[str]:
    """
...
VALIDADOR_EMAIL = ValidadorWrapper.criar_validador_opcional(
    lambda v, _c: v, "E-mail"
)  # Pydantic já valida
VALIDADOR_DATA_NASCIMENTO = ValidadorWrapper.criar_validador_opcional(
    validar_data_nascimento, "Data de nascimento", idade_minima=16
)
