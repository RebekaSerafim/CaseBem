...
INSERT INTO prestador_servico (id_profissional, id_servico, observacoes, preco)
VALUES (?, ?, ?, ?);
"""
...
WHERE id_profissional = ? AND id_servico = ?;
"""
...
SELECT id_profissional, id_servico, observacoes, preco
